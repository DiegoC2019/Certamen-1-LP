...
NUM_LAYERS = 5  # Cantidad de capas
        ...
        for y in range(GRID_HEIGHT):
            for x in range(GRID_WIDTH):
                if grids[i][y][x] == SUSCEPTIBLE:
                    # Regla 1: S a E si tiene 2 o más vecinos I en la misma capa
                    ...
                    exposed_time[y][x] += 1
                    if exposed_time[y][x] >= 15:  # Modificado para 10 actualizaciones
...
def update_and_redraw():
    ...
    draw_grids()
    root.after(1900, update_and_redraw)
