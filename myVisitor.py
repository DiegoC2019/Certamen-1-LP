from CellularAutomatonVisitor import CellularAutomatonVisitor # Permite visitar nodos específicos en un árbol de análisis sintáctico generado por ANTLR4 para el lenguaje definido en tu gramática 

class MyVisitor(CellularAutomatonVisitor): # Hereda de la clase CellularAutomatonVisitor.
